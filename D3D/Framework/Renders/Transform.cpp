...
void Transform::Position(Vector2 * vec)
{
	*vec = Vector2(position.x,position.y);
}
...
void Transform::Scale(Vector2 * vec)
{
	*vec = Vector2(scale.x, scale.y);
}
...
void Transform::Rotation(Vector2 * vec)
{
	*vec = Vector2(rotation.x, rotation.y);
}
